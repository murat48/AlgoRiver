...
export type TrailingStopLossComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  simulate(): Promise<TrailingStopLossComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<TrailingStopLossComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<TrailingStopLossComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  /**
